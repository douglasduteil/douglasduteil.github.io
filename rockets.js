(window.webpackJsonp=window.webpackJsonp||[]).push([[4],{79:function(t,e,a){"use strict";var i=a(7),l=a(80),n=a.n(l);const o=i.a.createStyleSheet(n.a);o.addRules({section:{backgroundColor:t=>t.bgColor},title:{backgroundColor:t=>t.bgColor}});const{classes:s}=o,r={};e.a=(t=>({title:e,children:a,bgColor:i,watermark:l})=>(o.update({bgColor:i}),t(r,":page-layout")`
    <div class=${s.watermark}>${l}</div>
    <h1 class=${s.title}>${e}</h1>
    <section class=${s.section}>${a}</section>
    <style>${{html:o.toString()}}</style>
  `))},80:function(t,e){t.exports={"@global":{"@media (min-width: 768px)":{main:{paddingLeft:"70px"}}},title:{position:"fixed",top:"0",left:"0",right:"0",zIndex:"100",transform:"translateZ(0)",willChange:"transform",textAlign:"center",margin:"0",padding:"1rem 0","@media (min-width: 768px)":{left:"70px"}},section:{flex:"1",display:"flex",padding:"20px",marginBottom:"50px","@media (min-width: 768px)":{marginBottom:"0",paddingBottom:"0"}},watermark:{position:"fixed",top:"0",bottom:"0",left:"0",right:"0",zIndex:"0",opacity:"0.1",display:"flex",alignItems:"center",justifyContent:"center",userSelect:"none",pointerEvents:"none","@global svg":{width:"170px",height:"170px"}}}},93:function(t,e){t.exports={"@global section":{marginTop:"4rem",justifyContent:"center",alignItems:"center"},ul:{listStyle:"none",padding:"0",margin:"0",display:"flex",flexWrap:"wrap",justifyContent:"center",alignContent:"center","@media (max-width: 767px)":{marginBottom:"-20px"}},li:{margin:"50px"},a:{textDecoration:"none",color:"#111",display:"table-cell",verticalAlign:"middle",textAlign:"center",width:"130px",height:"150px",background:"#fff",padding:"0 10px",transform:"rotate(-45deg)",position:"relative","&:before":{content:"''",position:"absolute",top:"0",bottom:"0",left:"0",right:"0",transform:"scale(1.1)",border:"2px solid white"}},text:{transform:"rotate(45deg)"}}},99:function(t,e,a){"use strict";a.r(e),a.d(e,"backgoundColor",function(){return p});var i=a(79),l=a(7),n=a(6),o=a(93),s=a.n(o);const r=l.a.createStyleSheet(s.a),{classes:c}=r,d={},p="#97A629";e.default=(({hyper:{wire:t}},e,a)=>Object(i.a)(t)({title:"Rockets",bgColor:p,watermark:Object(n.f)(t,e),children:t(d,":rockets")`
  <ul class=${c.ul}>
    <li class=${c.li}>
